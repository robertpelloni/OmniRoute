    ...
    <>
      ...
      >
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center justify-end gap-2 pt-2 border-t border-border">
            <Button title="Execute this action" size="sm" variant="secondary" onClick={() => setModalOpen(false)}>
              Cancel
            </Button>
            <Button title="Execute this action" size="sm" icon="save" onClick={handleSave} loading={saving}>
              Save
            </Button>
          </div>
        </div>
      ...
      >
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center justify-end gap-2 pt-2 border-t border-border">
            <Button title="Execute this action" size="sm" variant="secondary" onClick={() => setBulkOpen(false)}>
              Cancel
            </Button>
            <Button
              size="sm"
