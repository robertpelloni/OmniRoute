          ...
          <div className="flex flex-wrap gap-2">
            ...
            {ccCompatibleProviderEnabled && (
              <Button
                size="sm"
                icon="add"
                title="Add a custom Copilot-compatible Provider via OmniRoute registry"
            ...
            <Button
              size="sm"
              icon="add"
              title="Add an Anthropic-compatible Provider like open source Claude wrappers"
            ...
            <Button
              size="sm"
              icon="add"
              title="Add any OpenAI-compatible custom provider endpoint like vLLM"
