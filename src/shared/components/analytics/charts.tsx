...
export function AIPerformanceChart({ dailyTrend }) {
  if (!dailyTrend || dailyTrend.length === 0) return null;

  return (
    <Card className="p-6">
      <h3 className="text-[14px] font-semibold text-text-main mb-4 flex items-center gap-2">
        <span className="material-symbols-outlined text-[18px]">model_training</span>
        AI Routing Accuracy & Cost Savings
      </h3>
